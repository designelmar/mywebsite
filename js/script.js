...
$(document).ready(function () {
  ...
  $("#submit").submit(function (e) {
    ...
    if ($("#usernames").val().trim().length < 1) {
      alert("ad bos olammez");
    }
    else if ($("#numbers").val().trim().length < 1) {
      alert("Telefon bos olammez");
    }
    else {
      swal("Mesajınız göndərildi!", "Sizinlə əlaqə saxlanılacaq!", "success");
      // Ajax sorgusu
    }
  });
